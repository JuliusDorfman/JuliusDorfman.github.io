    ...
    return (
    	...
    	<div className="sidebar">
		  ...
		  <div className="sidebar-item sidebar-footer">
		    <p>This site was built utilizing React and Redux; deployed to both GitHub Pages and Heroku.<a></a></p>
		  </div>
		  ...
		  <div className="sidebar-item sidebar-footer">
		    ...
		    <p>
				Visit <a href="https://github.com/JuliusDorfman">My GitHub Repo</a><br/>
				Visit <a href="www.linkedin.com/in/juliusgdorfman">My Linkedin</a><br/>
		    </p>
